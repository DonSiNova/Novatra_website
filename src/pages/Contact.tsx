...
const contactFormSchema = z.object({
  ...
  industry: z.string().min(1, { message: "Please select an industry sector" }),
  message: z
    .string()
    .trim()
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10">
          <div className="max-w-3xl mx-auto text-center animate-fade-in">
            ...
            <p className="text-lg md:text-xl text-white/90">
              Ready to transform your industrial operations with intelligent solutions? 
            ...
            <div className="space-y-8 animate-fade-in">
              <div>
                ...
                <p className="text-muted-foreground mb-8">
                  Our team is here to answer your questions and explore how our solutions 
